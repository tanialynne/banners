...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Layer 1
	this.text = new cjs.Text("Virginia’s best 4-year schools.", "300 25px 'Oswald'", "#034262");
	this.text.textAlign = "center";
	this.text.lineHeight = 36;
	this.text.lineWidth = 395;
	this.text.setTransform(-2.5,-19.3);

	this.text_1 = new cjs.Text("Guaranteed transfer to", "300 25px 'Oswald'", "#034262");
...
p.nominalBounds = new cjs.Rectangle(-200,-44.3,400,63);
