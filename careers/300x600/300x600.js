...
lib.properties = {
	...
	manifest: [
		...
		{src:"_600_p4.jpg", id:"_600_p4"},
		{src:"_600_p5.jpg", id:"_600_p5"},
...
(lib._600_p4 = function() {
	this.initialize(img._600_p4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,300,190);


(lib._600_p5 = function() {
	this.initialize(img._600_p5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,300,190);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Layer 1
	this.text = new cjs.Text("2 Years or Less", "400 32px 'Oswald'", "#034262");
	this.text.textAlign = "center";
	this.text.lineHeight = 45;
	this.text.lineWidth = 296;
	this.text.setTransform(-2,12.7);

	this.text_1 = new cjs.Text("Great Jobs in", "400 32px 'Oswald'", "#034262");
...
p.nominalBounds = new cjs.Rectangle(-150,-38.3,300,98.5);
