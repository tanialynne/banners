...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("EARN MORE.", "400 36px 'Oswald'", "#A9B734");
...
p.nominalBounds = new cjs.Rectangle(-20,30,300,66.5);
...
(lib.Symbol7 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("PAY LESS.", "400 50px 'Oswald'", "#034262");
	this.text.lineHeight = 70;
	this.text.lineWidth = 377;
	this.text.setTransform(160,-15);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(160,-15,381,71.9);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// Layer 1
	this.text = new cjs.Text("Great Jobs in 2 Years or Less", "400 30px 'Oswald'", "#034262");
	this.text.textAlign = "center";
	this.text.lineHeight = 43;
	this.text.lineWidth = 396;
	this.text.setTransform(-2,-35.3);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-200,-35.3,400,44.8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(112).to({_off:false},0).to({y:70},10).wait(7));
