...
p.nominalBounds = new cjs.Rectangle(0,0,260,101);
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(22,-5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(22,-5,260,101);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(224.7,29.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("Ag0BJIAAiRIBoAAIAAAPIhXAAIAAAyIBNAAIAAAOIhNAAIAAAzIBYAAIAAAPg");
	this.shape_1.setTransform(215.3,29.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAwBJIhch2IAAB2IgQAAIAAiRIAPAAIBbB0IAAh0IAQAAIAACRg");
	this.shape_2.setTransform(199.5,29.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(182.3,29.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("Ag0BJIAAiRIBoAAIAAAPIhXAAIAAAyIBOAAIAAAOIhOAAIAAAzIBYAAIAAAPg");
	this.shape_4.setTransform(160.5,29.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(146.2,29.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(130.7,29.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(112.8,29.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAqBJIAAhCIhTAAIAABCIgQAAIAAiRIAQAAIAABBIBTAAIAAhBIAQAAIAACRg");
	this.shape_8.setTransform(95.9,29.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(80.5,29.8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(64).call(this.frame_64).wait(1).call(this.frame_65).wait(200).call(this.frame_265).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(210).to({_off:false},0).to({y:387.5,alpha:1},13).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(193).to({_off:false},0).to({y:128.5,alpha:1},13).wait(60));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(202).to({_off:false},0).to({y:273,alpha:1},13).wait(51));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(238).to({_off:false},0).to({y:482.5},13).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(183).to({_off:false},0).to({y:42.5},13).wait(70));

	// Layer 7
	this.instance_6 = new lib.Symbol5();
	this.instance_6.setTransform(150,654.5,1,1,0,0,0,150,25.5);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(16).to({_off:false},0).to({y:574.5},13).wait(142).to({y:654.5},11).wait(84));

	// Layer 12
	this.instance_7 = new lib.Symbol3();
	this.instance_7.setTransform(150,322.5,1,1,0,0,0,150,31.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(21).to({_off:false},0).to({alpha:1},13).wait(137).to({alpha:0},11).wait(84));

	// Layer 11
	this.instance_8 = new lib.Symbol6();
	this.instance_8.setTransform(150,299,1,1,0,0,0,150,300);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(75).to({_off:false},0).to({alpha:1},13).wait(83).to({alpha:0},11).wait(84));

	// Layer 10
	this.instance_9 = new lib.Symbol7();
	this.instance_9.setTransform(150,438.5,1,1,0,0,0,150,110.5);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(32).to({_off:false},0).to({alpha:1},13).wait(12).to({alpha:0.199},0).wait(5).to({alpha:1},0).wait(109).to({alpha:0},11).wait(84));

	// Layer 1
	this.instance_10 = new lib.Symbol1();
	this.instance_10.setTransform(150,205,1,1,0,0,0,150,121);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(23).to({_off:false},0).to({alpha:1},13).wait(13).to({alpha:0.199},0).wait(5).to({alpha:1},0).wait(117).to({alpha:0},11).wait(84));

	// Layer 6
	this.instance_11 = new lib.Symbol2();
	this.instance_11.setTransform(150,-57.5,1,1,0,0,0,150,42.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({y:42.5},13).wait(158).to({y:-57.5},11).wait(84));
