...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgFA0IAAgQIALAAIAAAQgAgCAWIgDhBIAAgIIALAAIAAAIIgDBBg");
	this.shape.setTransform(140.9,112.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AglA0IAAhnIBKAAIAAAKIg+AAIAAAkIA3AAIAAAJIg3AAIAAAlIA/AAIAAALg");
	this.shape_1.setTransform(134.1,112.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgFA0IAAhcIgjAAIAAgLIBRAAIAAALIgkAAIAABcg");
	this.shape_2.setTransform(124,112.9);
	...
	this.shape_3.setTransform(112.7,112.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgEA0IgthnIANAAIAkBYIAlhYIANAAIgtBng");
	this.shape_4.setTransform(100.7,112.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(84.2,112.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgFA0IAAhcIgjAAIAAgLIBRAAIAAALIgkAAIAABcg");
	this.shape_6.setTransform(73,112.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAdA0IgmgzIgXAXIAAAcIgLAAIAAhnIALAAIAAA8IA7g8IAPAAIgrAuIAtA5g");
	this.shape_7.setTransform(58.8,112.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(47.6,112.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgEA0IAAhnIAJAAIAABng");
	this.shape_9.setTransform(39.7,112.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgiA0IAAhnIALAAIAABcIA6AAIAAALg");
	this.shape_10.setTransform(33.2,112.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(22.9,112.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgdBqIAAgwIAwAAIAAAwgAgTAiIgHguIADgCQAZgBAMgHQAMgHAAgMIAAgBQAAgKgGgFQgIgGgMAAQgLAAgLAFQgLAFgLALIgcgfQANgOATgJQARgJAXAAQAQAAAOAEQANAEAJAIQAKAIAFAMQAFALABAPIAAABQAAAOgFAKQgFALgHAHQgJAFgKAEQgLAFgNACIgDASg");
	this.shape_12.setTransform(131.8,69.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAlBoIgshCIAAAAIgkAAIAABCIguAAIAAjPIBeAAQAogBAVAVQASASAAAeIAAABQAAAagMAOQgNAQgUAIIAzBKgAgrgBIAtAAQARAAAJgJQAJgHAAgOIAAgBQAAgPgJgIQgKgHgRAAIgsAAg");
	this.shape_13.setTransform(113.8,70.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhPBoIAAjPICdAAIAAAoIhvAAIAAArIBhAAIAAAoIhhAAIAAArIBxAAIAAApg");
	this.shape_14.setTransform(92.6,70.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgWBoIAAilIg/AAIAAgqICrAAIAAAqIg/AAIAAClg");
	this.shape_15.setTransform(72.4,70.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AhBBTQgZgYAAguIAAh2IAuAAIAAB0QAAAaAMANQAMANAUAAQAVAAAMgMQAMgNgBgZIAAh2IAvAAIAAB0QAAAYgHASQgGASgMAMQgMALgRAGQgSAGgTAAQgqAAgXgXg");
	this.shape_16.setTransform(51.3,70.2);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("");
	this.shape_17.setTransform(29.1,70.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("");
	this.shape_18.setTransform(124.1,36.9);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgcAdQAegDgCgaIgRAAIAAgvIAuAAIAAApQAAAcgOANQgOANgZAAg");
	this.shape_19.setTransform(109.9,31.2);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("");
	this.shape_20.setTransform(93.3,36.9);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AAqBpIAAhVIhTAAIAABVIguAAIAAjRIAuAAIAABUIBTAAIAAhUIAuAAIAADRg");
	this.shape_21.setTransform(69.1,36.9);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AAvBpIgviHIguCHIgoAAIhIjRIAyAAIArCMIAviMIAmAAIAvCMIAsiMIAwAAIhIDRg");
	this.shape_22.setTransform(40.9,37);
...
p.nominalBounds = new cjs.Rectangle(0,30,160,74);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(3).call(this.frame_3).wait(62).call(this.frame_65).wait(1).call(this.frame_66).wait(157));

	// Layer 7
	this.movieClip_1 = new lib.Symbol11();
	this.movieClip_1.setTransform(80,300,1,1,0,0,0,80,300);

	this.timeline.addTween(cjs.Tween.get(this.movieClip_1).wait(223));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(169).to({_off:false},0).to({y:531.5},14).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(193).to({_off:false},0).to({y:346,alpha:1},14).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(202).to({_off:false},0).to({y:417,alpha:1},14).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(185).to({_off:false},0).to({y:119.2,alpha:1},14).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(169).to({_off:false},0).to({y:16.5},14).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(14).to({_off:false},0).to({alpha:1},14).wait(127).to({alpha:0},13).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(91).to({_off:false},0).to({alpha:1},14).wait(50).to({alpha:0},13).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(24).to({_off:false},0).to({alpha:1},14).wait(12).to({alpha:0.199},0).wait(4).to({alpha:1},0).wait(101).to({alpha:0},13).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(33).to({_off:false},0).to({alpha:1},14).wait(9).to({alpha:0.199},0).wait(4).to({alpha:1},0).wait(95).to({alpha:0},13).wait(55));

	// Layer 5
	this.instance_9 = new lib.Symbol2();
	this.instance_9.setTransform(81,681,1,1,0,0,0,80,69);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({y:531},14).wait(141).to({y:691},13).wait(55));
