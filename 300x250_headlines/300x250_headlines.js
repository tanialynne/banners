...
lib.properties = {
	...
	manifest: [
		...
		{src:"TCC26673300x250_Headlines2_p1.jpg", id:"TCC26673300x250_Headlines2_p1"},
		{src:"TCC26673300x250_Headlines2_p2.jpg", id:"TCC26673300x250_Headlines2_p2"},
		{src:"TCC26673300x250_Headlines2_p3.jpg", id:"TCC26673300x250_Headlines2_p3"},
...
(lib.TCC26673300x250_Headlines2_p1 = function() {
	this.initialize(img.TCC26673300x250_Headlines2_p1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,300,173);


(lib.TCC26673300x250_Headlines2_p2 = function() {
	this.initialize(img.TCC26673300x250_Headlines2_p2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,300,173);


(lib.TCC26673300x250_Headlines2_p3 = function() {
	this.initialize(img.TCC26673300x250_Headlines2_p3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,143,176);
...
(lib.Symbol11 = function() {
	...
	// Layer 1
	this.instance = new lib.TCC26673300x250_Headlines2_p3();
	this.instance.setTransform(-71.5,-84);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-71.5,-84,143,176);
...
(lib.Symbol10 = function() {
	...
	// Layer 1
	this.instance = new lib.TCC26673300x250_Headlines2_p2();
...
(lib.Symbol3 = function() {
	...
	// Layer 1
	this.instance = new lib.TCC26673300x250_Headlines2_p1();
...
(lib.Symbol1copy2 = function() {
	...
	// Layer 1
	this.text = new cjs.Text("IN TWO YEARS OR LESS.", "22px 'Oswald'", "#034362");
...
(lib.Symbol1copy = function() {
	...
	// Layer 1
	this.text = new cjs.Text("HIGH-PAYING CAREER", "22px 'Oswald'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 24;
	this.text.lineWidth = 294;
	this.text.setTransform(-3,11.2);
...
(lib.Symbol1 = function() {
	...
	// Layer 1
	this.text = new cjs.Text("TRAIN FOR A", "22px 'Oswald'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 24;
	this.text.lineWidth = 294;
	this.text.setTransform(-3,11.2);
...
// stage content:
(lib._300x250_headlines = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(302).to({_off:false},0).to({alpha:1},13).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(232).to({_off:false},0).to({y:192,alpha:1},13).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(226).to({_off:false},0).to({y:125,alpha:1},13).wait(51).to({alpha:0},12).to({_off:true},1).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(142).to({_off:false},0).to({alpha:1},12).wait(59).to({alpha:0},12).to({_off:true},1).wait(97));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(149).to({_off:false},0).to({alpha:1},12).wait(52).to({alpha:0},12).to({_off:true},1).wait(97));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(142).to({_off:false},0).to({alpha:1},13).wait(168));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(81).to({_off:false},0).to({alpha:1},13).wait(48).to({alpha:0},12).to({_off:true},1).wait(168));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(74).to({_off:false},0).to({alpha:1},13).wait(55).to({alpha:0},12).to({_off:true},1).wait(168));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(6).to({_off:false},0).to({alpha:1},13).wait(49).to({alpha:0},12).to({_off:true},1).wait(242));

	// Layer 4
	this.instance_10 = new lib.Symbol1();
	this.instance_10.setTransform(150,195.7);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(13).to({_off:false},0).to({y:170.7,alpha:1},13).wait(42).to({alpha:0},12).to({_off:true},1).wait(242));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({alpha:1},13).wait(310));
