...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("fraction of the cost.", "300 27px 'Oswald'", "#034262");
	this.text.textAlign = "center";
	this.text.lineHeight = 39;
	this.text.lineWidth = 296;
	this.text.setTransform(-2,30.7);

	this.text_1 = new cjs.Text("your bachelor’s at a", "300 27px 'Oswald'", "#034262");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 39;
	this.text_1.lineWidth = 296;
	this.text_1.setTransform(-2,-10.3);

	this.text_2 = new cjs.Text("Earn half of", "300 27px 'Oswald'", "#034262");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 39;
	this.text_2.lineWidth = 296;
	this.text_2.setTransform(-2,-51.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_2},{t:this.text_1},{t:this.text}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-150,-51.3,300,122.7);
