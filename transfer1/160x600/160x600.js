...
lib.properties = {
	...
	manifest: [
		...
		{src:"_160_p1.jpg", id:"_160_p1"},
		{src:"_160_p2.jpg", id:"_160_p2"},
...
(lib._160_p1 = function() {
	this.initialize(img._160_p1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,160,190);


(lib._160_p2 = function() {
	this.initialize(img._160_p2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,160,190);
...
(lib.Symbol9 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("LESS.", "400 70px 'Oswald'", "#A9B734");
...
(lib.Symbol7 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text("ANYWHERE.", "400 27px 'Oswald'", "#034262");
	this.text.textAlign = "center";
	this.text.lineHeight = 39;
	this.text.lineWidth = 156;
	this.text.setTransform(-72,-60.6);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-150,-60.6,160,45.6);
...
(lib.Symbol5_1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.text = new cjs.Text(" the cost.", "300 21px 'Oswald'", "#034262");
	this.text.textAlign = "center";
	this.text.lineHeight = 31;
	this.text.lineWidth = 156;
	this.text.setTransform(-72,59.7);

	this.text_1 = new cjs.Text("at a fraction of", "300 21px 'Oswald'", "#034262");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 31;
	this.text_1.lineWidth = 156;
	this.text_1.setTransform(-72,19.7);

	this.text_2 = new cjs.Text("your bachelor’s ", "300 21px 'Oswald'", "#034262");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 31;
	this.text_2.lineWidth = 156;
	this.text_2.setTransform(-72,-21.3);

	this.text_3 = new cjs.Text("Earn half of", "300 21px 'Oswald'", "#034262");
	this.text_3.textAlign = "center";
	this.text_3.lineHeight = 31;
	this.text_3.lineWidth = 156;
	this.text_3.setTransform(-72,-62.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_3},{t:this.text_2},{t:this.text_1},{t:this.text}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-150,-62.3,160,162.7);
